...
<header>
  <h1>Juan Pérez</h1>
  <img src="137722774.jpg" alt="Foto de perfil" class="profile-pic" width="100px" id="photo">
</header>
  <p><b>Email:</b> annacast@espol.edu.ec | <b>Tel:</b> +593 95 265 3254</p>
  <p><b>LinkedIn:</b> <a href="https://linkedin.com/in/lolothens-e">lolothens-e</a> | <b>GitHub:</b> <a href="https://github.com/lolothens-e">lolothens-e</a></p>

  

<section>
  <h2 class="subtitle">🎯 Perfil Profesional</h2 class="subtitle">
...
<section>
  <h2 class="subtitle">💼 Experiencia Laboral</h2 class="subtitle">
  <ol>
    <li><article>
...
<section>
  <h2 class="subtitle">🎓 Educación</h2 class="subtitle">
  <p><b>Ingeniería en Computación</b> — Escuela Superior Politécnica del Litoral (2022 - Presente)</p>
</section>

<section>
  <h2 class="subtitle">🧠 Habilidades</h2 class="subtitle">
  <div class="skills">
    <table>
  <tr>
...
<section>
  <h2 class="subtitle">📽️ Descripciones técnicas de proyectos </h2 class="subtitle">
...
<section>
  <h2 class="subtitle">🌎 Referencias</h2 class="subtitle">
        <article>
            <p><b>"Un loco o el próximo Elon Musk"</b></p>
            <p><b>Edgar Andrade</b>, Ingeniero en Sistemas (UPS), Docente de Programación. Docente de 2018-2022</p>
        </article>
        <article>
            <p><b>"Una persona comprometida con su trabajo, siempre cumple con sus responsabilidades y se comunica con claridad"</b></p>
            <p><b>Shirley Aragón</b>, Estudiante de Ingeniería en Computación en ESPOL. Colaboró en variso grupos de trabajo a lo largo de la carrera.</p>
        </article>
        <article>
            <p><b>"Un profesional dedicado y que aporta un ambiente de trabajo acogedor y enfocado en lograr objetivos propuestos"</b></p>
            <p><b>Matías Collaguazo</b>, Estudiante de Ingeniería en Computación en ESPOL. Colaborador en proyecto de creación de redes multi-ciudad.</p>
        </article>
</section>

<section>
  <h2 class="subtitle">📌 Ubicación</h2 class="subtitle">
...
<section>
  <h2 class="subtitle">📭 Formulario de Contacto</h2 class="subtitle">   
